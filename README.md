About django-bootstrap4-feedstock
=================================
...
<table><tr>
    <td>All platforms:</td>
    <td>
      <a href="https://github.com/conda-forge/django-bootstrap4-feedstock/actions/workflows/conda-build.yml">
        <img src="https://github.com/conda-forge/django-bootstrap4-feedstock/actions/workflows/conda-build.yml/badge.svg?event=push&branch=main">
      </a>
    </td>
  </tr>
</table>
...
pixi add django-bootstrap4
# for installing globally
pixi global install django-bootstrap4
```
...
It is possible to list all of the versions of `django-bootstrap4` available on your platform:
...
```
pixi search django-bootstrap4 --channel conda-forge
```
